...
const Appbtn = ({title="click me",onClick}) => {
  return (
    <div className='relative h-12 w-[50%] overflow-hidden flex justify-center items-center rounded-md  shadow-md shadow-black hover:shadow-lg hover:shadow-gray-950 '>  
         <img src={BTNBG}/>
