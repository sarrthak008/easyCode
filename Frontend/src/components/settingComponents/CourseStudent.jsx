  ...
  return(
    <div className=' w-80 sm:w-96 bg-gray-900 backdrop-blur-md p-4 ml-2 sm:ml-0'>
      ...
      <div className='flex-wrap flex mt-2 '>
         <button className='w-full sm:w-[40%] m-3  rounded-sm text-center shadow-lg hover:bg-green-500   bg-green-400 py-1 text-2xl'>accept <i className="ri-user-add-line"></i></button>
         <button className='w-full sm:w-[40%] m-3  rounded-sm text-center shadow-lg hover:bg-red-500  bg-red-800  py-1 text-2xl' >reject <i className="ri-user-unfollow-line"></i></button>
      </div>
    </div>
  )
}
